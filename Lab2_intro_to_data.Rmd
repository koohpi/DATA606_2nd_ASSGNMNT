...
### Answer (Koohyar)
The difference is how more details are shown in a smaller bin width. In the case of bin width set to 15, you can see more details: in this bin width, you see more granular results compared to larger bins of default and 150. 
However, we must be careful when choosing the right bin width. A very small one also loses its value, because a histogram is useful to give you a sense of the data and its distribution. Thus, choosing the right bin width is important to define the value of histograms.
